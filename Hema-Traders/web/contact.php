			...
			<div class="col-md-6 w3_agileits_contact_grid_left">
				...
				<div class="agileits_w3layouts_map_pos">
					<div class="agileits_w3layouts_map_pos1">
						<h3>Contact Info</h3>
						<p>48, Chandra Society, Odhav Road,Ahmedabad-380018</p>
						<ul class="wthree_contact_info_address">
							<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">hematraders@gmail.com</a></li>
							<li><i class="fa fa-phone" aria-hidden="true"></i>+91 95102 01225</li>
						</ul>
